...
map.getView().fit([1790959.057242, 10508292.016420, 1792105.728398, 10508977.553155], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">storjord_hytter (QFieldCloud)</h2>';
        return titleElement;
    })(),
